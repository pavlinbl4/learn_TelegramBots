...
BOT_TOKEN = Credentials().pavlinbl4_bot
...
# и предлагать перейти к заполнению анкеты, отправив команду /add_image
...
# handler_03 будет срабатывать на команду "/cancel" в любых состояниях,
...
# handler_04 будет срабатывать на команду /add_image
...
async def process_add_image_command(message: Message, state: FSMContext):
    await message.answer(text='Пожалуйста, отправте снимок боту как файл')
    # Устанавливаем состояние ожидания ввода имени
    await state.set_state(FSMFillForm.add_file)


# handler_05 будет срабатывать, если введено корректное имя
...
# handler_06 будет срабатывать, если во время ввода имени
...
# handler_07 будет срабатывать, если введен корректный возраст
...
# handler_08 будет срабатывать, если во время ввода возраста
# будет введено что-то некорректное
@dp.message(StateFilter(FSMFillForm.fill_age))
...
# handler_09 будет срабатывать на нажатие кнопки при
...
# handler_10 будет срабатывать, если во время выбора пола
...
# handler_11 будет срабатывать, если отправлено фото
...
# handler_12 будет срабатывать, если во время отправки фото
# будет введено/отправлено что-то некорректное
@dp.message(StateFilter(FSMFillForm.upload_photo))
...
# handler_13 будет срабатывать, если выбрано образование
...
# handler_14 будет срабатывать, если во время выбора образования
# будет введено/отправлено что-то некорректное
...
# handler_15 будет срабатывать на выбор получать или
...
# handler_16 будет срабатывать, если во время согласия на получение
...
# handler_17 будет срабатывать на отправку команды /showdata
...
# handler_18 будет срабатывать на любые сообщения, кроме тех
